...
namespace Axis.Elements
{
    ...
    public class AxisMannequin : NodeProcessor
    {
        ...
        {
            nodesByLimb[NodeBinding.Hips].transform.rotation = nodesByLimb[NodeBinding.WaistHub].transform.rotation;
            hipsRotationSolver.SolveHipsRotation(bodyModelAnimatorLink, nodesByLimb[NodeBinding.Hips].transform);
        }
        ...
        public virtual void HandleNodeDataUpdated(Dictionary<NodeBinding, AxisNode> nodesByLimb)
        {
            ...
            //foreach (CharacterAnimatorLink characterAnimatorLink in outputCharactersAnimatorLink)
            //{
